...
public class SwaggerConfig {
	...
	private ApiInfo apiEndpointInfo() {
		return new ApiInfoBuilder().title("REST API Documentation Organization Service")
				.description("This is api documentation for Documentation Organization Service")
